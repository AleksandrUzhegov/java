...
public class TaskController {
    ...
    public List<StatusDto> showListStatuses(@RequestParam(value = "token", required = false) String token
                                           ,Model model)
    {
    ...
    public List<UserDto> showListUsers(@RequestParam(value = "token", required = false) String token
                                      ,Model model)
    {
